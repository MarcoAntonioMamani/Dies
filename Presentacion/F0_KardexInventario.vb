...
Public Class F0_KardexInventario
...
#End Region
    ...
    Private Sub P_PonerDatosBusqueda()
        Tb1CodEquipo.Text = Dgj2Busqueda.GetValue("numi").ToString
        Tb2DescEquipo.Text = Dgj2Busqueda.GetValue("desc").ToString
        SuperTabPrincipal.SelectedTabIndex = 0
    ...
    Private Sub SuperTabControl1_SelectedTabChanged(sender As Object, e As DevComponents.DotNetBar.SuperTabStripSelectedTabChangedEventArgs) Handles SuperTabPrincipal.SelectedTabChanged
    ...
    Private Sub P_ArmarGrillaAyuda() 'Grilla para Buscar Clientes
        ...
        dt = L_GetProductos(" ldap=1").Tables(0)
