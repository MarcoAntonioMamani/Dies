...
Public Class Pr_HistorialRemolqueCliente
...
#Region "Metodos Privados"
    Private Sub _prIniciarTodo()
        ...
        Me.Text = "R E P O R T E  H I S T O R I A L   S E R V I C I O S  R E M O L Q U E"
    ...
    Private Sub _prCargarReporte()
        ...
        If (tbFiltrarCliente.Value = True) Then
            ...
            _dt = L_prReporteHistorialServiciosRemolque(tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"), NumiClie)
        Else
            _dt = L_prReporteHistorialServiciosPorPlacarRemolque(tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"), numiVehiculo)
        End If

        If (_dt.Rows.Count > 0) Then
            Dim fecha As String = tbFechaI.Value.Date.ToString("dd/MM/yyyy") + " Al " + tbFechaF.Value.Date.ToString("dd/MM/yyyy")
            Dim objrep As New R_HistorialServRemolqueCliente
    ...
    Private Sub TextBoxX1_KeyDown(sender As Object, e As KeyEventArgs) Handles tbcliente.KeyDown
        If e.KeyData = Keys.Control + Keys.Enter Then
            ...
            If frmAyuda.seleccionado = True Then
                ...
                tbPlaca.Text = frmAyuda.filaSelect.Cells("rbplac").Value.ToString
