...
Public Class R_ServLavadero1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_ServLavadero1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_ServLavadero1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ServLavadero1 = New R_ServLavadero1()
        rpt.Site = Me.Site
        Return rpt
    End Function
