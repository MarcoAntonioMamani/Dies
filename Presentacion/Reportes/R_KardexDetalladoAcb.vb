...
Public Class R_KardexDetalladoAcb
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "R_KardexDetalladoAcb.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_KardexDetalladoAcb.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_KardexDetalladoAcb
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_KardexDetalladoAcb = New R_KardexDetalladoAcb()
        rpt.Site = Me.Site
        Return rpt
    End Function
