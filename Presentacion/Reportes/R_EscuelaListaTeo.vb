...
Public Class R_EscuelaListaTeo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_EscuelaListaTeo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_EscuelaListaTeo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_EscuelaListaTeo = New R_EscuelaListaTeo()
        rpt.Site = Me.Site
        Return rpt
    End Function
