...
Public Class R_ReservaHotel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_ReservaHotel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_ReservaHotel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ReservaHotel = New R_ReservaHotel()
        rpt.Site = Me.Site
        Return rpt
    End Function
