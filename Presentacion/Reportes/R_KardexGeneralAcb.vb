...
Public Class R_KardexGeneralAcb
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_KardexGeneralAcb.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_KardexGeneralAcb
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_KardexGeneralAcb = New R_KardexGeneralAcb()
        rpt.Site = Me.Site
        Return rpt
    End Function
