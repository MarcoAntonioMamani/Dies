...
Public Class R_SocioCumpleanhos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_SocioCumpleanhos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_SocioCumpleanhos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_SocioCumpleanhos = New R_SocioCumpleanhos()
        rpt.Site = Me.Site
        Return rpt
    End Function
