...
Public Class R_SocioListaSociosActivos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "R_SocioListaSociosActivos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_SocioListaSociosActivos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TipoSocio() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedR_SocioListaSociosActivos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_SocioListaSociosActivos = New R_SocioListaSociosActivos()
        rpt.Site = Me.Site
        Return rpt
    End Function
