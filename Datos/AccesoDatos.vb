...
Public Class AccesoDatos
    ...
    Shared _ComandoDiconta As SqlCommand
    Public Shared Sub D_abrirConexionHistorial(Optional Ip As String = "", Optional UsuarioSql As String = "", Optional ClaveSql As String = "", Optional NombreBD As String = "")
        _ComandoDiconta = MetodoDatos.CrearComando(Ip, UsuarioSql, ClaveSql, NombreBD)
    ...
    Public Shared Function D_Datos_TablaDiconta(_Campos As String, _Tabla As String, _Where As String) As DataTable
        'Dim _comando As OleDbCommand = MetodoDatos.CrearComando()
        _ComandoDiconta.CommandText = "SELECT " + _Campos + " FROM " + _Tabla + " WHERE " + _Where
        Return MetodoDatos.EjecutarComandoSelect(_ComandoDiconta)
    End Function
    ...
    Public Shared Function D_Maximo(_Tabla As String, _Campo As String, _Where As String) As DataTable
        ...
        Return MetodoDatos.EjecutarComandoSelect(_comando)
    End Function
    Public Shared Function D_MaximoDiconta(_Tabla As String, _Campo As String, _Where As String) As DataTable
        'Dim _comando As OleDbCommand = MetodoDatos.CrearComando()
        _ComandoDiconta.CommandText = "SELECT MAX(" + _Campo + ") FROM " + _Tabla + " WHERE " + _Where
        Return MetodoDatos.EjecutarComandoSelect(_ComandoDiconta)
    End Function
    ...
    End Function
    Public Shared Function D_Insertar_DatosDiconta(_Tabla As String, _Campos As String) As Boolean
        'Dim _comando As OleDbCommand = MetodoDatos.CrearComando()
        _ComandoDiconta.CommandText = "Insert Into " + _Tabla + " Values(" + _Campos + ")"

        Return MetodoDatos.EjecutarInsert(_ComandoDiconta)

    End Function

    Public Shared Function D_Modificar_DatosDiconta(_Tabla As String, _Campos As String, _Where As String) As Boolean
        'Dim _comando As OleDbCommand = MetodoDatos.CrearComando()
        _ComandoDiconta.CommandText = "Update " + _Tabla + " Set " + _Campos + " Where " + _Where
    ...
    End Function
    Public Shared Function D_Eliminar_DatosDiconta(_Tabla As String, _Where As String) As Boolean
        'Dim _comando As OleDbCommand = MetodoDatos.CrearComando()
        _ComandoDiconta.CommandText = "Delete From " + _Tabla + " Where " + _Where
